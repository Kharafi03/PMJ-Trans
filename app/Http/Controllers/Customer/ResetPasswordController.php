...
class ResetPasswordController extends Controller
{
    ...
    {
        return view('frontend.auth.reset'); // Sesuaikan nama view dengan yang Anda gunakan
    }
    ...
    public function sendWhatsApp(Request $request)
    {
        ...
        // Format pesan
        $message = "Halo saya {$name}, saya ingin mengubah password untuk akun dengan nomor handphone {$number_phone} dengan password baru yaitu {$password}";
