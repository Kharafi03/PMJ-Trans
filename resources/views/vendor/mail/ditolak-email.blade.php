...
<head>
    ...
    <style>
        ...
        .email-header {
            text-align: center;
            padding: 20px 0;
            background: linear-gradient(to right, #d9534f, #e67372);
            color: white;
...
<body>
    ...
    <div class="email-container">
        <div class="email-header">
            <h2>Pemesanan Ditolak - PMJ Trans</h2>
        </div>

        <div class="email-body">
            <h1>Maaf, Pemesanan Anda Tidak Dapat Diproses</h1>
            <p>Kami mohon maaf, tetapi pemesanan Anda dengan kode booking 
                <strong>{{ $booking->booking_code ?? '#' }}</strong> telah ditolak.</p>
            <p>Berikut ini adalah detail pemesanan Anda:</p>
