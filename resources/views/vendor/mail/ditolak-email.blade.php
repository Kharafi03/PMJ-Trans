...
<body>
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p style="font-family: 'Poppins', sans-serif; color: #666666 !important;">Dengan berat hati, kami informasikan bahwa pemesanan Anda dengan kode booking 
                <strong>{{ $booking->booking_code ?? '#' }} telah ditolak.</strong> Jika Anda ingin memesan kembali, pastikan untuk mengisi formulir pemesanan dengan benar.</p>
            ...
            <div class="info-content">
                ...
                <p align="center" style="color: #666666 !important;">Jika anda ingin memesan ulang kembali, klik tombol di bawah ini : </p>

                <center>
                    <a href="https://api.whatsapp.com/send?phone={{ $setting ? $setting->first()->contact : '#' }}&text=Halo,%20saya%20ingin%20bertanya" class="btn">Pesan Ulang</a>
                </center>
            </div>
        </div>
