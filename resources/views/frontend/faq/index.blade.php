...
@push('styles')
    <title>FAQ</title>
    <link id="pagestyle" href="{{ asset('css/frontend/css/faq-style.css') }}" rel="stylesheet" />
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            Apakah pembayaran harus lunas?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Pembayaran bisa dilakukan dengan membayar DP terlebih dahulu, untuk
                            pelunasanya boleh setelah trip.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
