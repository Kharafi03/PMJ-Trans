            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="header mb-5">
                        <h5>Login</h5>
                        <p><span>Gunakan nomor telepon yang aktif dan dapat dihubungi.</span> Jika Anda belum memiliki akun, silakan <a href="{{ route('register') }}">Registrasi di sini.</a></p>
                    </div>
                    ...
                    <!-- FORM -->
                     <div class="form-login>">
                        <form id="formLogin">
                            <div class="mb-5">
                                <label for="noTelp" class="form-label">Nomor Telephone<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="noTelp" placeholder="Masukkan no telephone aktif" required>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <button type="button" class="btn-login" onclick="prosesLogin()">LogIn</button>
                            </div>                             
                        </form>
                     </div>
                </div>
