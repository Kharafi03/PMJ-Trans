    ...
    <main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
        ...
        <section id="Thumbnail" class="flex relative h-[370px] pt-[94px] pb-[66px] bg-[#F6F6F6]">
            ...
            <div class="w-full h-[210px] flex items-center justify-center flex-shrink-0">
                <img id="mainThumbnail" src="{{ asset('assets/images/thumbnails/iPhone 15 Pro Main.png') }}"
                    alt="Thumbnail" class="size-full object-contain transition-opacity duration-500 ease-in-out" />
            </div>
            ...
            <div class="flex gap-4 absolute -bottom-[35px] w-full items-center justify-center">
                <button
                    ...
                    <img src="assets/images/thumbnails/iPhone 15 Pro Main.png" alt="Thumbnail" class="size-full" />
                </button>
                <button
                    class="thumbnail-button size-[70px] flex p-[15px_20px] rounded-full overflow-hidden bg-white flex-shrink-0 th-inactive">
                    <img src="assets/images/thumbnails/iPhone 15 Pro Natural Titanium 1.png" alt="Thumbnail"
                        class="size-full" />
                </button>
                <button
                    class="thumbnail-button size-[70px] flex p-[15px_20px] rounded-full overflow-hidden bg-white flex-shrink-0 th-inactive">
                    <img src="assets/images/thumbnails/iPhone 15 Pro Model 1.png" alt="Thumbnail" class="size-full" />
                </button>
                <button
                    class="thumbnail-button size-[70px] flex p-[15px_20px] rounded-full overflow-hidden bg-white flex-shrink-0 th-inactive">
                    <img src="assets/images/thumbnails/iPhone 15 Pro Main.png" alt="Thumbnail" class="size-full" />
        ...
        <section id="Details" class="flex flex-col mt-[65px] px-5 w-full gap-5">
            <div id="Heading" class="flex items-center justify-between">
                <div class="flex flex-col gap-1">
                    <h1 class="text-[22px] leading-[33px] font-bold">iPhone 15 Pro Max</h1>
                    <p class="text-[#6E6E70]">Phone</p>
                </div>
                <div class="flex">
                    <div class="size-5 flex shrink-0">
                        <img src="assets/images/icons/Star.svg" alt="icon" class="size-full" />
                    </div>
            ...
            <div id="About" class="flex flex-col gap-1">
                ...
                <p class="leading-[30px]">You’ll see the improvements in your own portraits. And now you no longer have
                    take switch to Portrait mode subject AI mode.</p>
            </div>
            <div id="Benefits" class="flex flex-col gap-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div
                        ...
                        <div class="flex gap-3 items-center">
                            <div class="size-6 flex shrink-0">
                                <img src="assets/images/icons/note-favorite.svg" alt="icon" class="size-full" />
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-3 items-center">
                            <div class="size-6 flex shrink-0">
                                <img src="assets/images/icons/dollar-circle.svg" alt="icon" class="size-full" />
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-3 items-center">
                            <div class="size-6 flex shrink-0">
                                <img src="assets/images/icons/location.svg" alt="icon" class="size-full" />
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-3 items-center">
                            <div class="size-6 flex shrink-0">
                                <img src="assets/images/icons/shield-tick.svg" alt="icon" class="size-full" />
                            </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="pb-4 border-b border-[#EDEEF0]">
                        <div class="flex gap-3">
                            ...
                            <div class="size-[50px] flex shrink-0 rounded-full overflow-hidden">
                                <img src="assets/images/photos/photo-1.png" alt="icon" class="size-full" />
                            </div>
                    ...
                    <div class="pb-4 border-b border-[#EDEEF0]">
                        <div class="flex gap-3">
                            <!-- photo -->
                            <div class="size-[50px] flex shrink-0 rounded-full overflow-hidden">
                                <img src="assets/images/photos/photo-2.png" alt="icon" class="size-full" />
                            </div>
                            <div class="flex flex-col gap-[6px] w-full">
                                <div class="flex items-center justify-between">
                                    <p class="text-sm leading-[21px] font-semibold">Sara Putri</p>
                    ...
                    <div class="pb-4">
                        <div class="flex gap-3">
                            <!-- photo -->
                            <div class="size-[50px] flex shrink-0 rounded-full overflow-hidden">
                                <img src="assets/images/photos/photo-3.png" alt="icon" class="size-full" />
                            </div>
                            <div class="flex flex-col gap-[6px] w-full">
                                <div class="flex items-center justify-between">
                                    <p class="text-sm leading-[21px] font-semibold">Sara Putri</p>
