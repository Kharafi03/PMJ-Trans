                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.driver.edit', $driver) }}" class="btn btn-success shadow-sm float-right">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post"
                                action="{{ route('admin.driver.update_gambar', ['driver' => $driver->id, 'gambar' => $gambar]) }}"
